========================================================================
    DYNAMIC LINK LIBRARY: InstancingPerformance.Resources-Projektübersicht
========================================================================

Diese InstancingPerformance.Resources-DLL wurde vom Anwendungs-Assistenten für Sie erstellt.  

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre InstancingPerformance.Resources-Anwendung besteht.

InstancingPerformance.Resources.vcxproj
...
InstancingPerformance.Resources.vcxproj.filters
...
InstancingPerformance.Resources.cpp
    Dies ist die Hauptquelldatei der DLL.

InstancingPerformance.Resources.h
